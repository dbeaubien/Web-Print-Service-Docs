    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/jdcryer/web-print-service-docs/tree/main/',
        },
        blog: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/jdcryer/Web-Print-Service-Docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Telekinetix Ltd - Built with Docusaurus.`,
      },
      prism: {
